...

{
    public partial class Parametricas
    {
        ...
        public GenClasificadortipoDto _GenClasificadortipo = new GenClasificadortipoDto();
        ...
        //AGREGAR FUNCIONES DE GENCLASIFICADORTIPO  INICIO-------------------------

        private async Task OnValidGenClasificadortipo(EditContext context)
        {
            await SaveClasificadortipo();
            Console.WriteLine("OnValidAMedidaNuevo");
        }
        protected async Task SaveClasificadortipo()
        {
            try
            {
                //string transporteJson = JsonConvert.SerializeObject(_TransporteAlmacen);
                ...
                //return;
                _Loading.Show();
                var vrespost = await _Rest.PostAsync<int?>("GenClasificadortipo", new { GenClasificadortipo = _GenClasificadortipo });
        ...
        //AGREGAR FUNCIONES DE GENCLASIFICADORTIPO  FIN-------------------------
