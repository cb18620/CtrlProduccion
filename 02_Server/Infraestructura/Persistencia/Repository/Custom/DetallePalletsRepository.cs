...
{
    public class DetallePalletsRepository : IDetallePalletsRepository
    {

        private readonly AplicationDbContext _context;
        public DetallePalletsRepository(AplicationDbContext context)
        {
            _context = context;
        }

        public async Task<Response<List<AlmContenidoPalletsDto>>> GetDestallePallet(int idCabecera)
        {
