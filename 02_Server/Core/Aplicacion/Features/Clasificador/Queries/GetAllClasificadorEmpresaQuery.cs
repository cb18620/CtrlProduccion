...
{
    public class GetAllClasificadorEmpresaQuery : IRequest<Response<List<GenClasificadorDto>>>
    {
        public class GetClasificadorQueryHandler : IRequestHandler<GetAllClasificadorEmpresaQuery, Response<List<GenClasificadorDto>>>
        {
            ...
            public async Task<Response<List<GenClasificadorDto>>> Handle(GetAllClasificadorEmpresaQuery request, CancellationToken cancellationToken)
            {
    ...
    public class GetClasificadorQuerySpecification : Specification<GenClasificador>
    {
        ...
        {
            Query.Where(x => x.IdgenClasificadortipo == (int)Enums.ClasificadorTipo.TipoEmpresa);
        }
    }
}
