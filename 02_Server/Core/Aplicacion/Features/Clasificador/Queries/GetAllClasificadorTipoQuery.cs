...
{
    public class GetAllClasificadorTipoQuery : IRequest<Response<List<GenClasificadorDto>>>
    {
        public class GetClasificadorQueryHandler : IRequestHandler<GetAllClasificadorTipoQuery, Response<List<GenClasificadorDto>>>
        {
            ...
            public async Task<Response<List<GenClasificadorDto>>> Handle(GetAllClasificadorTipoQuery request, CancellationToken cancellationToken)
            {
                var _resp = new Response<List<GenClasificadorDto>>();
                try
                {
                    var _resul = await _repo.ListAsync(new GetClasificadorTipoQuerySpecification(), cancellationToken);
    ...
    public class GetClasificadorTipoQuerySpecification : Specification<GenClasificador>
    {
        public GetClasificadorTipoQuerySpecification()
        {
            Query.Where(x => x.IdgenClasificadortipo == (int)Enums.ClasificadorTipo.tipos);
        }
    }
}
